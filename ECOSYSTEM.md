...
> Note: PyPI column — "—" = not applicable (public GitHub only); "**Not published**" = could be published to PyPI but hasn't been yet.
...
|----|-------|--------|-------------|--------|
| XB-001 | Split-adjusted prices needed | kr-derivatives Run 1 | kr-dart-pipeline `extract_price_volume.py` | **FIXED** (2026-03-15, `9b99bfb`) |
| XB-002 | SEIBRO API resultCode=99 | krff-shell | External (공공데이터포털 revising API) | **DEFERRED** until end of April 2026 |
